...
$ads_txt_themoneytizer = file_get_contents('https://ads.themoneytizer.com/ads_txt.php?site_id=137927&id=129210');
if (empty($ads_txt_themoneytizer)) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_URL, 'https://ads.themoneytizer.com/ads_txt.php?site_id=137927&id=129210');
...
foreach ($explode_ads_txt as $k => $v) {
    // Keep raw line for local to preserve comments or complex formatting if needed, 
    // but the script logic provided forces a trim/replace.
    // I will use the script EXACTLY as provided by the user.
